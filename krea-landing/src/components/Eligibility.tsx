        ...
        <div className="mb-32">
          ...
          >
              <div className="md:w-1/3">
                <div className="w-20 h-20 bg-white/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#8a2214] transition-colors duration-500 shadow-[0_0_15px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_30px_rgba(138,34,20,0.5)]">
                   <span className="material-symbols-outlined text-4xl text-white transition-colors duration-500">fact_check</span>
                </div>
                <h2 className="text-4xl font-black mb-4">{eligibilityData.eligibility.title}</h2>
                <p className="text-white font-medium opacity-80 italic">Requirements for aspiring clinical psychologists</p>
              </div>
